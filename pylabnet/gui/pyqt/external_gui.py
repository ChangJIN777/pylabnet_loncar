    ...
    def __init__(self, parent_wins, app, log_client=None, template="Confluence_info_window"):
        ...
        if (self.enable):
            try:
                ...
                self.log.info("Confluence:.env does not have confluence key! Disable the confluence functions")
                self.enable = False
...
class LaunchControl_Confluence_Windows(QtWidgets.QMainWindow):
    ...
    def __init__(self, controller, app, template='Confluence_info_from_LaunchControl'):
        ...
        try:
            ...
            self.enable = False
            controller.gui_logger.info("Launcher Confluence: Cannot find the confluence key in the .env! Disable the confluence functions")
